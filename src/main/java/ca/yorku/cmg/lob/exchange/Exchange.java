...
public class Exchange {
	...
	public void submitOrder(IOrder o, long time) {
		...
		for (ITrade t:oOutcome.getResultingTrades()) {
			...
			accounts.getTraderAccount(t.getBuyer()).deductFromBalance(buyerFee);
			//Apply the trade payment to the account balance of the buyer (they spent money)
			accounts.getTraderAccount(t.getBuyer()).deductFromBalance(t.getPrice() * t.getQuantity());
			//Add the bought stocks to the position of the buyer
			accounts.getTraderAccount(t.getBuyer()).updatePosition(t.getTicker(), t.getQuantity());
			...
			accounts.getTraderAccount(t.getSeller()).deductFromBalance(sellerFee);
			//Apply the trade payment to the account balance of the seller (they earned money)
			accounts.getTraderAccount(t.getSeller()).addToBalance(t.getPrice() * t.getQuantity());
			//Deduct the sold stocks from the position of the seller
			accounts.getTraderAccount(t.getSeller()).updatePosition(t.getTicker(), -t.getQuantity());
